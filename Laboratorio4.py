...
def bpa(estado_inicio, estado_solucion):
    ...
    tendrá que hacer una búsqueda y la solución ya estaría planteada desde el inicio'''
    lista_costos = [0]
        ...
        if nodo_actual.get_datos() == estado_solucion:
            ...
            for i in range(len(estado_inicial)-1):
                ...
                if not hijo.en_lista(nodos_visitados) and not hijo.en_lista(nodos_frontera):
                    ...
                    '''Creamos una variable costo que será el párametro que le pasaremos a la función set_costo del hijo para que así no esté vacío.
            ...
            '''Creamos un indice con un valor de 0 que es el que irá ordenando listas. Se irá reseteando porque en cada creación de hijos, los costos
            ...
            comprobar en la lista_costos. Si se el caso planteado, entonces añadimos el costo en la posición encontrada a la lista auxiliar y como
            mencionabamos que el indice de cada costo pertence a su igual en los nodos_frontera, se tomará la posición de los nodos_frontera y se
